...
2. 众多参数中需要注意`x:*`类型的参数，该参数属于`系统自义定参数`，`参数值`被系统所处理，其余参数是 OOS 运营商所需要使用的，在[「获取上传Token」](https://doc.careyshop.cn/docs/admin_api/a-21523337935 "「获取上传Token」")可获得，只要原样填写即可。
